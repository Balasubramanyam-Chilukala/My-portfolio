    ...
    <header className="bg-white shadow-md">
      <nav className="container mx-auto px-6 py-3">
        <ul className="flex justify-center space-x-6">
          ...
          <li><Link href="#education" className="text-gray-800 hover:text-blue-600">Education</Link></li>
          <li><Link href="#achievements" className="text-gray-800 hover:text-blue-600">Achievements</Link></li>
